...
// static int upperBoundBlock(std::vector<int> &arr, int target, size_t index, size_t size_of_pair) {
// 	size_t n = index + 1; // nombre de blocs + 1 for 3
// 	size_t lower = 1, high = n;
// 	size_t res = 0; // index

// 	std::cout << "index_max: " << n;
// 	// std::cout <<" target: "<< target;
// 	while (lower <= high) {
// 		size_t mid = lower + (high - lower) / 2;
// 		int val = arr[(mid * size_of_pair) - 1];
// 		std::cout <<" val: "<< val;
// 		if (val <= target) {
// 			res = mid;       // ce mid est un candidat valide
// 			lower = mid + 1; // on cherche plus grand bloc possible
// 		} else {
// 			high = mid - 1;
// 		}
// 	}
// 	return ((res != 0) ? ((res * size_of_pair) - 1) : (0)); // index de la pair
// }




// static size_t upperBoundBlock(std::vector<int> &arr, int target, size_t index, size_t size_of_pair) {
// 	size_t n = index + 2; // nombre de blocs + 1 for 3
// 	size_t lower = 0, high = n;
// 	size_t mid = 0;
// 	// std::cout << "index_max: " << n;
// 	// std::cout <<" target: "<< target;
...
// 		int val = arr[((mid == 0) ? (0) : (mid * size_of_pair - 1))];
...
// 	mid = lower + (high - lower) / 2;
// 	if (mid == 0 && target < arr[0])
// 		return (0);
// 	else if (target > arr[(n * size_of_pair) - 1]) {std::cout << "test"; // plus grand que max index
// 		return ((n * size_of_pair) - 1);}
// 	// else if ()
// 	// std::cout <<" res: "<< res<<"\n";
// 	// int val = arr[res * size_of_pair - 1];
// 	// std::cout <<" vval: "<< val<<"\n";
// 	// if (val < target)
// 	// 	std::cout << "youpi";
...
// 	// std::cout <<" high: "<< high<<"\n";
// 	return ((mid != 0) ? ((mid * size_of_pair) - 1) : (0)); // index du bloc
// }
